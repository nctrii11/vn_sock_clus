...
def plot_price_evolution(prices: pd.DataFrame, title: str = "VN30 Stock Prices Evolution") -> None:
...
def plot_correlation_heatmap(corr: pd.DataFrame, title: str = "Stock Correlation Matrix") -> None:
...
def plot_portfolio_weights(weights: pd.Series, title: str = "Portfolio Weights") -> None:
...
def plot_drawdown(equity: pd.Series, title: str = "Portfolio Drawdown") -> None:
...
def plot_performance_summary(metrics: dict, title: str = "Performance Summary") -> None:
    ...
    labels = ['Total Return', 'Annualized Return', 'Volatility', 'Sharpe Ratio']
    ...
    risk_labels = ['Max Drawdown', 'Sortino Ratio', 'Calmar Ratio']
    ...
    ax3.pie([hit_ratio, 1-hit_ratio], labels=['Winning Days', 'Losing Days'], 
            colors=['#2E86AB', '#E63946'], autopct='%1.1f%%', startangle=90)
    ax3.set_title('Hit Ratio', fontsize=14, fontweight='bold')
